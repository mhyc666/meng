...
public class MessageFragment extends EaseConversationListFragment {
    ...
    protected void initView() {
        super.initView();
        titleBar.setBackgroundColor(ContextCompat.getColor(getActivity(), R.color.light_red));
        titleBar.setRightImageResource(R.mipmap.friend);
        titleBar.setRightLayoutClickListener(v -> startActivity(new Intent(getActivity(),ContactListActivity.class)));
